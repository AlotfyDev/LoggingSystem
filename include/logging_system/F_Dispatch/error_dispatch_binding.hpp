...
/*
------------------------------------------------------------------------------
F_Dispatch/error_dispatch_binding.hpp
...
------------------------
ErrorDispatchBinding is the ERROR-pipeline specialization of the generic dispatch
binding family.

It answers one narrow question:
    "Which dispatch-layer components constitute the dispatch stack for the ERROR
     pipeline right now?"
...
- ERROR-specific queue policy types
- ERROR-specific failure policy types
...
using ErrorDispatchBinding = logging_system::A_Core::DispatchBinding<
    ThreadPoolDispatchExecutor,
    QueuePolicy,
    DispatchFailurePolicy,
    DefaultAdapterEmission>;
