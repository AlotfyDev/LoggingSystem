...
/*
------------------------------------------------------------------------------
F_Dispatch/warn_dispatch_binding.hpp
...
------------------------
WarnDispatchBinding is the WARN-pipeline specialization of the generic dispatch
binding family.

It answers one narrow question:
    "Which dispatch-layer components constitute the dispatch stack for the WARN
     pipeline right now?"
...
- WARN-specific queue policy types
- WARN-specific failure policy types
