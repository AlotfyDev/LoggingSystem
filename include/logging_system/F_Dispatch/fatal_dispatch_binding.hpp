...
/*
------------------------------------------------------------------------------
F_Dispatch/fatal_dispatch_binding.hpp
...
------------------------
FatalDispatchBinding is the FATAL-pipeline specialization of the generic dispatch
binding family.

It answers one narrow question:
    "Which dispatch-layer components constitute the dispatch stack for the FATAL
     pipeline right now?"
...
- FATAL-specific queue policy types
- FATAL-specific failure policy types
