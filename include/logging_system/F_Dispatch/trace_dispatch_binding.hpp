...
/*
------------------------------------------------------------------------------
F_Dispatch/trace_dispatch_binding.hpp
...
------------------------
TraceDispatchBinding is the TRACE-pipeline specialization of the generic dispatch
binding family.

It answers one narrow question:
    "Which dispatch-layer components constitute the dispatch stack for the TRACE
     pipeline right now?"
...
- TRACE-specific queue policy types
- TRACE-specific failure policy types
