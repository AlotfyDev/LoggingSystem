...
/*
------------------------------------------------------------------------------
E_Resolvers/fatal_resolver_binding.hpp
...
------------------------
FatalResolverBinding is the FATAL-pipeline specialization of the generic resolver
binding family.

It answers one narrow question:
    "Which resolver implementations constitute the resolver stack for the FATAL
     pipeline right now?"
...
- replacing one or more default resolvers with FATAL-specific specializations
