...
/*
------------------------------------------------------------------------------
E_Resolvers/debug_resolver_binding.hpp
...
------------------------
DebugResolverBinding is the DEBUG-pipeline specialization of the generic resolver
binding family.

It answers one narrow question:
    "Which resolver implementations constitute the resolver stack for the DEBUG
     pipeline right now?"
...
- replacing one or more default resolvers with DEBUG-specific specializations
