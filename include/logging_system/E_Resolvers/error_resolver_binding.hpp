...
/*
------------------------------------------------------------------------------
E_Resolvers/error_resolver_binding.hpp
...
------------------------
ErrorResolverBinding is the ERROR-pipeline specialization of the generic resolver
binding family.

It answers one narrow question:
    "Which resolver implementations constitute the resolver stack for the ERROR
     pipeline right now?"
...
- replacing one or more default resolvers with ERROR-specific specializations
...
using ErrorResolverBinding = logging_system::A_Core::ResolverBinding<
    DefaultWriterResolver,
    DefaultDispatcherResolver,
    DefaultReadonlyResolver>;
