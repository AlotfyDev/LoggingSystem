...
/*
------------------------------------------------------------------------------
E_Resolvers/trace_resolver_binding.hpp
...
------------------------
TraceResolverBinding is the TRACE-pipeline specialization of the generic resolver
binding family.

It answers one narrow question:
    "Which resolver implementations constitute the resolver stack for the TRACE
     pipeline right now?"
...
- replacing one or more default resolvers with TRACE-specific specializations
