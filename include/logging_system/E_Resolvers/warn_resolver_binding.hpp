...
/*
------------------------------------------------------------------------------
E_Resolvers/warn_resolver_binding.hpp
...
------------------------
WarnResolverBinding is the WARN-pipeline specialization of the generic resolver
binding family.

It answers one narrow question:
    "Which resolver implementations constitute the resolver stack for the WARN
     pipeline right now?"
...
- replacing one or more default resolvers with WARN-specific specializations
