...
/*
------------------------------------------------------------------------------
D_Preparation/fatal_preparation_binding.hpp
...
- replacing one or more default preparation components with FATAL-specific
  specializations
- policy-bound preparation variants
- FATAL-local schema shaping rules
