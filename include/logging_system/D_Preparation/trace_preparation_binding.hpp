...
/*
------------------------------------------------------------------------------
D_Preparation/trace_preparation_binding.hpp
...
- replacing one or more default preparation components with TRACE-specific
  specializations
- policy-bound preparation variants
- TRACE-local schema shaping rules
