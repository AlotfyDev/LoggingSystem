...
/*
------------------------------------------------------------------------------
D_Preparation/error_preparation_binding.hpp
...
- replacing one or more default preparation components with ERROR-specific
  specializations
- policy-bound preparation variants
- ERROR-local schema shaping rules
