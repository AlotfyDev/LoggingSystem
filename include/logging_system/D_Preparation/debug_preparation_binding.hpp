...
/*
------------------------------------------------------------------------------
D_Preparation/debug_preparation_binding.hpp
...
- replacing one or more default preparation components with DEBUG-specific
  specializations
- policy-bound preparation variants
- DEBUG-local schema shaping rules
